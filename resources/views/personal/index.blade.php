                ...
                <div class="mx-10 flex flex-col">
                    <div class="flex items-center flex-wrap justify-between pb-2">
                      ...
                      <div class="flex items-center gap-10 justify-between">
                        <div class=" ">
                          <x-second-button :href=" route('personal.create') ">
                            Añadir
                          </x-second-button>
                        </div>
                      </div>
                        ...
                        <table class="w-full">
                          <thead>
                            <tr class="text-left text-sm font-semibold uppercase tracking-widest text-white">
                              ...
                              <th class="px-5 py-3">Jerarquia</th>
                          ...
                          <tbody class="text-gray-200">
                            ...
                            <tr class="border-t-2 border-gray-600">
                              <td class="px-5 py-5 text-sm">
                                <p class="whitespace-no-wrap">{{ $personal->nombre }}</p>
                              </td>
                              <td class="px-5 py-5 text-sm">
                                <div class="flex items-center">
                                  <div class="">
                                    <p class="whitespace-no-wrap">{{ $personal->dni }}</p>
                                  </div>
                                </div>
                              </td>
                              <td class="px-5 py-5 text-sm">
                                <div class="flex items-center">
                                  <div class="">
                                    <p class="whitespace-no-wrap">{{ $personal->jerarquia }}</p>
                                  </div>
                                </div>
                              </td>
                              <td>
                                <div class="flex gap-4">
                                  <a href="{{ route('personal.edit', $personal->id) }}" class="hover:text-blue-600 text-white">Editar</a>
                                  
                                  <form class="hover:text-red-500 boton-eliminar" method="POST" action="{{ route('personal.destroy', $personal->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit">
                                        Eliminar
