            ...
            <img src="{{ asset('uploads/avatars').'/'.$user->avatar }}" alt="" class="h-9 w-9 rounded-full">
                  ...
                  <div class="mx-10 flex flex-col">
                      <div class="flex items-center flex-wrap justify-between pb-2">
                        <div>
                          <h2 class="font-semibold text-white uppercase">Administracion del personal</h2>
                        </div>
                          ...
                          <div class="container mx-auto">
                            <div class="w-5/6 lg:w-1/2 mx-auto bg-gray-800 rounded-lg shadow">
                              <div class="py-4 text-white px-8 text-xl border-grey-lighter">
                                <span><strong>Registrar personal</strong></span>
                              </div>
                                  <form method="POST" action="{{ route('personal.store') }}" class="py-4 px-8 shadow-xl rounded-b-xl">
                                    @csrf  
                                      <div class="mb-4">
                                          <label class="after:content-['*'] after:text-red-400 block text-gray-300 text-sm  mb-2" for="nombre">Nombre</label>
                                          <input class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100" id="nombre" name="nombre" type="text" placeholder="Ingrese nombre">
                                      ...
                                      <div class="mb-4">
                                          ...
                                          <input class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100" id="dni" name="dni" type="text" placeholder="Ingrese DNI">
                                      ...
                                      <div class="mb-4">
                                        ...
                                        <select name="jerarquia" id="jerarquia" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100">
                                            <option value="" selected disabled>Selecionar Jerarquia</option>
