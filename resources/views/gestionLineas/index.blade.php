                  ...
                  <div class="mx-10 flex flex-col">
                      <div class="flex items-center flex-wrap justify-between pb-2">
                        ...
                        <div class="flex items-center gap-10 justify-between">
                          <div class=" ">
                            <x-second-button :href=" route('gestionLineas.create') ">
                              Añadir
                            </x-second-button>
                          </div>
                        </div>
                              ...
                              <tr class="border-t-2 border-gray-600">
                                ...
                                <td>
                                  <div class="flex gap-4">
                                    <a href="{{ route('gestionLineas.edit', $gestionLinea->id) }}" class="hover:text-blue-600 text-white">Editar</a>
                                    
                                    <form class="hover:text-red-500 boton-eliminar" method="POST" action="{{ route('gestionLineas.destroy', $gestionLinea->id) }}">
                                      @csrf
                                      @method('DELETE')
                                      <button type="submit">
                                          Eliminar
