                          ...
                          <div class="container mx-auto">
                            <div class="w-5/6 lg:w-1/2 mx-auto bg-gray-800 rounded-lg shadow">
                              <div class="py-4 text-white px-8 text-xl border-grey-lighter">
                                <span><strong>Actualizar linea</strong></span>
                              </div>
                                  <form method="POST" action="{{ route('lineas.update', $linea->id) }}" enctype="multipart/form-data" class="py-4 px-8  rounded-b-xl">
                                    @csrf  
                                    @method('PUT')
                                      <div class="mb-4">
                                          <label class="after:content-['*'] after:text-red-400 block text-gray-300 text-sm  mb-2" for="linea">Línea</label>
                                          <input value="{{ $linea->linea }}" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100" id="linea" name="linea" type="text" placeholder="Ingrese línea">
                                      ...
                                      <div class="mb-4">
                                        ...
                                        <select name="tipo" id="tipo" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100">
                                            <option value="{{ $linea->tipo }}">{{ $linea->tipo }}</option>
                                            @if ($linea->tipo == 'Usuario')
                                      ...
                                      <div class="mb-4">
                                          ...
                                          <input value="{{ $linea->plan }}" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100" id="plan" name="plan" type="text" placeholder="Ingrese plan">
                                      ...
                                      <div class="mb-4">
                                        ...
                                        <input value="{{ $linea->precio }}" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100" id="precio" name="precio" type="text" placeholder="Ingrese precio">
                                      ...
                                      <div class="mb-4">
                                        ...
                                        <input value="{{ $linea->sim }}" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100" id="sim" name="sim" type="text" placeholder="Ingrese SIM">
                                      ...
                                      <div class="mb-4">
                                        ...
                                        <select name="sede" id="sede" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100">
                                          <option value="{{ $linea->sede }}" selected disabled>{{ $linea->sede }}</option>
                                      ...
                                      <div class="mb-4">
                                        ...
                                        <select name="estado" id="estado" class="appearance-none bg-gray-700 border-none text-sm rounded w-full py-2 px-3 text-gray-100">
                                            <option value="{{ $linea->estado }}" selected>{{ $linea->estado }}</option>
